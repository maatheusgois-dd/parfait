...
final class MicRecorder: @unchecked Sendable {
    ...
    /// holds exclusive access to that mic during a call, so Parfait may fail to start.
    ...
    func start(writingTo url: URL) throws {
        ...
        do {
            ...
            do {
                ...
                ParfaitConsoleLog.recording("mic started on built-in fallback [\(builtInName)]")
    ...
    private func startEngineLocked(writingTo url: URL) throws {
        ...
        guard inputFormat.sampleRate > 0, inputFormat.channelCount > 0 else {
            ParfaitConsoleLog.recording("mic input unavailable — zero sample rate or channels")
    ...
    func stop() {
        ...
        if let saved {
            ...
            savedDefaultInputDevice = nil
            ParfaitConsoleLog.recording("mic restored default input device")
        }
    }
    ...
    private func restartAfterConfigurationChange() {
        ...
        do {
            ...
            ParfaitConsoleLog.recording("mic restart after config change failed — \(error.localizedDescription)")
