...
enum MeetingNotice {
    ...
    static var emptyTranscript: Presentation {
        Presentation(
            ...
            message: "Parfait didn't detect any speech in this recording. Resume if the meeting is still live, or write notes manually.",
    ...
    private static var speakerIdentification: Presentation {
        Presentation(
            ...
            message: "The transcript is ready, but Parfait couldn't identify who said what. You can still read and edit the notes.",
    ...
    private static func transcriptionFailed(mic: Bool, call: Bool) -> Presentation {
        ...
        case (true, true):
            return Presentation(
                ...
                message: "Parfait ran into a problem reading the audio. If the meeting is still going, resume recording to capture the rest.",
                systemImage: "waveform.badge.exclamationmark",
                isEmptyTranscript: true)
        case (true, false):
            return Presentation(
                title: "Your microphone wasn't transcribed",
                message: "Parfait couldn't read your side of the call. The other side may still appear in the transcript.",
                systemImage: "mic.slash",
                isEmptyTranscript: false)
        case (false, true):
            return Presentation(
                title: "Call audio wasn't transcribed",
                message: "Parfait couldn't read the other side of the call. Your microphone may still appear in the transcript.",
