...
private struct ParfaitActionColorKey: EnvironmentKey {
    static let defaultValue = Theme.action
}

extension EnvironmentValues {
    var parfaitActionColor: Color {
        get { self[ParfaitActionColorKey.self] }
        set { self[ParfaitActionColorKey.self] = newValue }
    }
}

struct ParfaitAppearanceModifier: ViewModifier {
    ...
    func body(content: Content) -> some View {
        ...
        content
            ...
            .environment(\.parfaitActionColor, action)
    }
}

extension View {
    func parfaitAppearance() -> some View {
